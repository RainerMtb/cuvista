...
namespace cu {
	...
	cudaError_t scale_32f8u(float* src, int srcStep, uchar* dest, int destStep, int w, int h, cudaStream_t cs = 0);
	...
	cudaError_t yuv_to_rgb(float* src, int srcStep, uchar* dest, int destStep, int w, int h);
}