...
7. Create subclass of MovieWriter and open output - this is called per output frame
8. Create subclass of MovieFrame handler class - this selects the loop mechanism
9. Create subclass of FrameExecutor - this selects the device for computations
10. Create subclass of progress handler - this informs about progress during loop
11. Run the loop in the frame class
12. Close Writer
13. Close Reader
14. Close Executor
15. Close Frame
...
or build with Media Auto Build https://github.com/m-ab-s/media-autobuild\_suite
